        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    index_1.copy({ appPath: appPath, template: template });
                    return [4 /*yield*/, index_1.init({ appName: appName, appPath: appPath, useYarn: useYarn, useGit: useGit, useTests: useTests, template: template })];
                case 1:
                    _b.sent();
                    console.info('⚡ DONE');
